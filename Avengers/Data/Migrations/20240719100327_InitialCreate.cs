        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    homeroom_teacher = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HomeworkAssignments_Subjects_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkCreations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HomeworkCreations_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                name: "Homework_assignmentsStudents",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Homework_assignmentsStudents", x => new { x.AssignmentsId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_Homework_assignmentsStudents_HomeworkAssignments_AssignmentsId",
                        column: x => x.AssignmentsId,
                        principalTable: "HomeworkAssignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Homework_assignmentsStudents_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Homework_assignmentsStudents_StudentsId",
                table: "Homework_assignmentsStudents",
                column: "StudentsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkCreations_StudentId",
