...
namespace Avengers.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,homeroom_teacher")] Classes classes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,homeroom_teacher")] Classes classes)
        {
            if (id != classes.Id)
            {
                return NotFound();
